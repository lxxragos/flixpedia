...
<head>
    ...
    <title>FLIXMEDIA-drama view</title>
...
<body id="page-top">
    ...
    DramaBoardDto dto = (DramaBoardDto)request.getAttribute("dramaboardDto");
    	dto = (dto == null) ? new DramaBoardDto() : dto;
    %>
    <!-- Page Wrapper -->
    <div id="wrapper">
				    ...
				    <div class="row">
				        <div class="col-md-3 border-right">
				            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
				                <img class="rounded mt-5" style="width:80%; height:auto;" id="uplaod" src="../../upload/<%=dto.getDrama_images() %>">       
				            </div>
				        </div>
				        <div class="col-md-5 border-right">
				            ...
				            <div class="row mt-3">
				                ...
				                <textarea readonly="readonly" class="form-control" id="contents" name="contents" placeholder="drama contents" 
				             ...
				             <div class="row mt-3">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="attendance" id="drama_avg_ratings" name="enter_avg_ratings"
				                value="<%=dto.getDrama_avg_ratings()%>">
				                </div>
				                <div class="col-md-4">
				                <label class="labels">제작년도</label>
				                <input readonly="readonly" type="text" class="form-control" placeholder="productionyear" id="drama_productionyear" name="drama_productionyear"
				                value="<%=dto.getDrama_productionyear()%>">
				                </div>
				                <div class="col-md-4">
				                <label class="labels">연령제한</label>
				                <input readonly="readonly" type="text" class="form-control" placeholder="agelimit" id="drama_agelimit" name="drama_agelimit"
				            ...
				            <div class="row mt-3">
				                ...
				                <textarea readonly="readonly" class="form-control" id="drama_url" name="drama_url" placeholder="URL address" 
...
{
   var frm = document.myform;
   frm.action="<%=request.getContextPath()%>/admin/dramaboard/modify";
   frm.submit();
}
...
function goDelete()
{
   ...
   {
      var frm = document.myform;
      frm.action="<%=request.getContextPath()%>/admin/dramaboard/delete";
      frm.submit();
   }
}
