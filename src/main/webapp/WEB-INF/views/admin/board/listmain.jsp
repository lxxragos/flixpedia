            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">등록할 게시물의 카테고리를 선택해주세요 <a
                            href="https://getbootstrap.com/docs">FLIXPEDIA</a> 유저 페이지에서 등록된 게시물 확인 가능합니다.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4 py-3 border-left-primary">
                                <div class="card-body">
                                    <a href="${commonURL}/admin/movieboard/list">영화</a>
                                </div>
                            </div>
                            ...
                            <div class="card mb-4 py-3 border-left-success">
                                <div class="card-body">
                                    <a href="${commonURL}/admin/toonboard/list">웹툰</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4 py-3 border-bottom-primary">
                                <div class="card-body">
                                    <a href="${commonURL}/admin/aniboard/list">애니</a>
                                </div>
                            </div>
