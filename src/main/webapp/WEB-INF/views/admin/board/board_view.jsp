...
<head>
    ...
    <link href="<%=request.getContextPath()%>/admin/resources/css/sb-admin-2.min.css" rel="stylesheet">
</head>
				    ...
				    <div class="row">
				        <div class="col-md-3 border-right">
				            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
				                <img class="rounded mt-5" style="width:80%; height:auto;" id="uplaod" src="../upload/<%=dto.getImages() %>">       
				                <!-- <input type="file" class="form-control" id="uplaod" name="upload" 
				                        placeholder="이미지를 업로드하세요" value="<%=dto.getImages() %>"/> -->
				        ...
				        <div class="col-md-5 border-right">
				            ...
				            <div class="row mt-3">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="attendance" id="attendance" name="attendance"
...
function goMain()
{
	location.href="${commonURL}/home";	//페이지 이동	
}
</script>