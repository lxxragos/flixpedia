				    ...
				    <div class="row" style="justify-content:center">
				        <div class="col-md-6">
				            ...
				            <div class="row mt-2">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="category" id="name1" name="name1"
				                value="<%=dto.getName1()%>" >
				                </div>
				                <div class="col-md-6">
				                <label class="labels">id</label>
				                <input readonly="readonly" type="text" class="form-control" placeholder="genre" id="id" name="id"
				                value="<%=dto.getId()%>" >
				                </div>
				            </div>
				            <div class="row mt-2">
				                ...
				                <input readonly="readonly" type="text" class="form-control" placeholder="producer" id="name2" name="name2"
				                value="<%=dto.getName2()%>" >
				                </div>
				            </div>
				            <div class="row mt-3">
				                ...
				                <textarea readonly="readonly" class="form-control" id="content" name="content" placeholder="enter contents" 
...
function goList()
{
   ...
   frm.action="<%=request.getContextPath()%>/admin/list";
   frm.submit();
}
