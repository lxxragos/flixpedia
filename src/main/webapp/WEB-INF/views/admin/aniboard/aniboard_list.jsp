                    ...
                    <form name="myform">
                        ...
                        <div class="container" style="margin-top:80px">
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                <%
                                List<AniBoardDto> list = (List<AniBoardDto>)request.getAttribute("aniboardList");
                                                                for(AniBoardDto tempDto : list){
                                %>
                                  <tr>
                                    <td><%=totalCnt - tempDto.getRnum()+1%></td>
                                    <td><%=tempDto.getCategory_code()%></td>
                                    <td><%=tempDto.getGenre_code()%></td>
                                    <td><a href="#none" onclick="goView('<%=tempDto.getBoard_seq()%>')"><%=tempDto.getAni_title()%></a></td>
                                    <td><%=tempDto.getAni_producer()%></td>
...
<script>
	...
	function goPage(pg){
		...
		frm.pg.value = pg;
		frm.method = "get";
		frm.action = "${pageContext.request.contextPath}/admin/aniboard/list";
		frm.submit();
	}
