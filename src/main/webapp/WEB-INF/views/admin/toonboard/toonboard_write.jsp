...
<head>
    ...
    <title>FLIXMEDIA-toon write</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<input type="hidden" name="hit" id="hit" value="<%=dto.getToon_hit() %>"/>
				    ...
				    <div class="row">
				        <div class="col-md-5 border-right">
					            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
									...
									<input type="file" class="form-control" id="uplaod" name="upload" 
					                        placeholder="이미지를 업로드하세요" value="<%=dto.getToon_images() %>" onchange="readURL(this);"/>
					                        <br/><br/>
									<img id="preview" src="../../upload/<%=dto.getToon_images() %>"style="width:50%; height:auto;"/>
									<input type="hidden" name="toon_images" value="<%=dto.getToon_images() %>"/>
					            </div>
				        </div>
				        <div class="col-md-7 border-right">
				            ...
				            <div class="row mt-2">
				                ...
				                <input type="text" class="form-control" placeholder="title" id="toon_title" name="toon_title"
				                value="<%=dto.getToon_title()%>">
				                </div>
				                <div class="col-md-6">
				                <label class="labels">감독</label>
				                <input type="text" class="form-control" placeholder="author" id="toon_author" name="toon_author"
				            ...
				            <div class="row mt-3">
				                ...
				                <textarea class="form-control" id="toon_content" name="toon_content" placeholder="enter contents" 
				            ...
				            <div class="row mt-3">
				                ...
				                <input type="text" class="form-control" placeholder="productionyear" id="toon_productionyear" name="toon_productionyear"
				                value="<%=dto.getToon_productionyear()%>">
				                </div>
				                <div class="col-md-6">
				                <label class="labels">연령제한</label>
				                <input type="text" class="form-control" placeholder="agelimit" id="toon_agelimit" name="toon_agelimit"
				                value="<%=dto.getToon_agelimit()%>">
				                </div>
				            </div>
				            <div class="row mt-3">
				                <div class="col-md-12">
				                <label class="labels">관련 url</label>
				                <textarea class="form-control" id="toon_url" name="toon_url" placeholder="URL address" 
...
<script>
	function goWrite()
	{
		...
		if(frm.toon_title.value.trim().length==0)
		{
			alert("제목을 작성하세요");
			frm.toon_title.focus();
			return false;
		}
		if(frm.toon_author.value.trim().length==0)
		{
			alert("이름을 작성하세요");
			frm.toon_author.focus();
			return false;
		}
		if(frm.toon_content.value.trim().length==0)
		{
			alert("내용을 작성하세요");
			frm.toon_content.focus();
			return false;
		}
		if(frm.toon_url.value.trim().length==0)
		{
			alert("영상 주소를 작성하세요");
			frm.toon_url.focus();
			return false;
		}
		if(frm.toon_productionyear.value.trim().length==0)
		{
			alert("제작년도를 작성하세요");
			frm.toon_productionyear.focus();
			return false;
		}
		if(frm.toon_agelimit.value.trim().length==0)
		{
			alert("제한연령을 작성하세요");
			frm.toon_agelimit.focus();
			return false;
		}
	
		frm.action="<%=request.getContextPath()%>/admin/toonboard/save";
		frm.method="post";
		frm.submit(); //서버로 전송하기
	}
