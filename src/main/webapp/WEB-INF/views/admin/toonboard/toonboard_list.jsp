                    ...
                    <form name="myform" method="post">
                        ...
                        <div class="container" style="margin-top:80px">
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                <%
                                List<ToonBoardDto> list = (List<ToonBoardDto>)request.getAttribute("toonboardList");
                                                                for(ToonBoardDto tempDto : list){
                                %>
                                  <tr>
                                    <td><%=totalCnt - tempDto.getRnum()+1%></td>
                                    <td><%=tempDto.getCategory_code()%></td>
                                    <td><%=tempDto.getGenre_code()%></td>
                                    <td><a href="#none" onclick="goView('<%=tempDto.getBoard_seq()%>')"><%=tempDto.getToon_title()%></a></td>
                                    <td><%=tempDto.getToon_author()%></td>
...
<script>
	...
	function goPage(pg){
		...
		frm.pg.value = pg;
		frm.method = "get";
		frm.action = "${pageContext.request.contextPath}/admin/toonboard/list";
		frm.submit();
	}
