...
<%@ page import="com.semi.flix.Visit.*" %>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                일방문자수</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${totalCnt}</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${cnt}</div>
                                                </div>
                                                <div class="col">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                고객Q&A</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${q_a_cnt}</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-secondary"></i> 드라마
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> 애니
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> 예능
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-warning"></i> 웹툰
                                        </span>
                                    </div>
                                </div>
                            </div>
...
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["영화", "드라마", "애니", "예능", "웹툰"],
    datasets: [{
      data: [${category.m},${category.d},${category.a},${category.e},${category.t}],
      backgroundColor: ['#4e73df', '#858796', '#1cc88a', '#36b9cc', '#f6c23e'],
      hoverBackgroundColor: ['#0d6efd', '#6c757d', '#198754', '#0dcaf0', '#ffc107'],
...
<%
List<VisitDto> list = (List<VisitDto>)request.getAttribute("dataList");
for(VisitDto dto : list){
	int month = Integer.parseInt(dto.getMonth())-1;
	int monthCnt = Integer.parseInt(dto.getM_cnt());

%>
dataList[<%=month%>] = <%=monthCnt%>;
