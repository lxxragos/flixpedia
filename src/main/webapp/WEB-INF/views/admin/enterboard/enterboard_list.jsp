...
<head>
    ...
    <title>FLIXMEDIA-enter list</title>
                    ...
                    <form name="myform" method="post">
                        ...
                        <div class="container" style="margin-top:80px">
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                <%
                                List<EnterBoardDto> list = (List<EnterBoardDto>)request.getAttribute("enterboardList");
                                                                for(EnterBoardDto tempDto : list){
                                %>
                                  <tr>
                                    <td><%=totalCnt - tempDto.getRnum()+1%></td>
                                    <td><%=tempDto.getCategory_code()%></td>
                                    <td><%=tempDto.getGenre_code()%></td>
                                    <td><a href="#none" onclick="goView('<%=tempDto.getBoard_seq()%>')"><%=tempDto.getEnter_title()%></a></td>
                                    <td><%=tempDto.getEnter_producer()%></td>
...
<script>
	...
	function goPage(pg){
		...
		frm.pg.value = pg;
		frm.method = "get";
		frm.action = "${pageContext.request.contextPath}/admin/enterboard/list";
		frm.submit();
	}
